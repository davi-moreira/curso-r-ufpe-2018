...
library(knitr)
library(magrittr)
data.frame(variable = names(bd),
           classe = sapply(bd, typeof),
           first_values = sapply(bd, function(x) paste0(head(x),  collapse = ", ")),
           row.names = NULL) %>% 
  kable()
```
...
# Atividade Prática - Git Commit

* Assista ao Webinar [\textcolor{blue}{Managing Part 2}](https://www.rstudio.com/resources/webinars/rstudio-essentials-webinar-series-managing-part-2/). Faça o versionamento do seu projeto e crie um repositório público.
